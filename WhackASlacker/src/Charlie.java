...
public class Charlie extends Character {
    ...
    //Sprites
    private final String imgPath = "src/res/img/charliespritesheet.png";
    private final ImageIcon[] spriteFrames;
    private final int numFrames = 29;
    ...
    private final int upEnd = 27;
    private final int downStart = 27;
    private final int downEnd = 0;
    //GamePlay Info
    private final int points = 420;
    private final int timeUp = 420; //Time in Milliseconds
    private final int ranking = 1;

    public Charlie(GamePlay g, JFrame fr){
        game = g;
        frame = fr;
        BufferedImage img;
        try{
